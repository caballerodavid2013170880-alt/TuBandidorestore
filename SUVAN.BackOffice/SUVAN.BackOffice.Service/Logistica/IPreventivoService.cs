...
namespace SUVAN.BackOffice.Service.Logistica
{
    public interface IPreventivoService
    {
        ...
        Task<List<DetPrevMoItemViewModel>> GetDetalleVehiculosAsync(int idEmpresa, int idPreventivo = 0);
        Task<List<PreventivoViewModel.CatalogItemViewModel>> GetDropdownPreventivos(int idEmpresa);
    }
}