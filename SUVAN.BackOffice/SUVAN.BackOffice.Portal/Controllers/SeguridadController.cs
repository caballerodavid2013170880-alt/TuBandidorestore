...
namespace SUVAN.BackOffice.Portal.Controllers
{
  public class SeguridadController : Controller
  {
    ...
    public SeguridadController(ILogger<SeguridadController> logger,
      IOptions<MFASettingsOptions> mfaSettings,
      IHttpContextAccessor httpContextAccessor,
      IAdminService adminService,
      INotificacionCorreoService notificacionCorreoService,
      IPerfilService perfilService,
      IMFAPortalService mFAPortalService,
      IAuthenticationClaimService authenticationClaimService,
      IBitacoraWebService bitacoraWebService,
    ...
    public async Task<IActionResult> Olvido(OlvidoContraViewModel model)
    {
      try
      {
        ...
        //var olvidoResult = await adminService.OlvidoContraUsuarioApp(model.Email);
