...
// Configuraci�n de la cultura global
...
{
  options.HeaderName = "X-CSRF-TOKEN"; // Opcional, define un encabezado espec�fico
});
...
if (!app.Environment.IsDevelopment())
{
  ...
  // Configurar una p�gina de error personalizada para el c�digo de estado 404.
