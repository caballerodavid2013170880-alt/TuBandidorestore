...
public partial class SuvanCambiosDbContext : DbContext
{
    public SuvanCambiosDbContext()
    {
    }

    public SuvanCambiosDbContext(DbContextOptions<SuvanCambiosDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=18.204.213.117;database=suvan_cambios_db;uid=survanusr;pwd=Qwerty!23.", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.31-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetPrev>(entity =>
        {
            ...
            entity.HasOne(d => d.IdManoObraNavigation).WithMany(p => p.DetPrevs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detprev_manoobra");
