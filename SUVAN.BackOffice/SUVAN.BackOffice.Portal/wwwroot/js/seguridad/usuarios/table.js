  ...
  var handleDeleteRows = () => {
    ...
    deleteButtons.forEach(d => {
      ...
      d.addEventListener('click', function (e) {
        ...
        Swal.fire({
          text: `¿Esta seguro que desea desactivar al usuario ${userName}?`,
          icon: "warning",
          ...
          preConfirm: async () => {
            ...
            const userId = parseInt(d.getAttribute('data-kt-user-delete-item'));
          ...
          if (result.value) {
            Swal.fire({
              text: `Usted desactivo al usuario ${userName}`,
              icon: "success",
              buttonsStyling: false,
              ...
              d.remove();
              parent.querySelectorAll('td')[2].innerText = 'No';
            }).then(function () {
