    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: `¿Esta seguro que desea eliminar el modelo ${contenidoName}?`,
                    icon: "warning",
                    ...
                    preConfirm: async () => {
                        ...
                        const IdModelo = parseInt(d.getAttribute('data-kt-modelo-delete-item'));
                        const response = await fetch('/Modelo/EliminarModelo', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                            body: JSON.stringify({ IdModelo: IdModelo })
                        });
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: `Usted eliminó el modelo ${contenidoName}`,
                            icon: "success",
                            buttonsStyling: false,
