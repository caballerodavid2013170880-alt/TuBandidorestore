...
var KTTallerList = function () {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-taller-table-filter="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-taller-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: `¿Esta seguro que desea eliminar el taller ${contenidoName}?`,
                    icon: "warning",
