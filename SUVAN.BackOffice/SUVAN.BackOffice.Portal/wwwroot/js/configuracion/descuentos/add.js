...
var KTDescuentos = function () {
  ...
  var handleValidation = function (e) {
        ...
        fields: {
          ...
          'Correos': {
            validators: {
              notEmpty: {
                enable: false,
                message: 'Lista de correos requerida'
              }
            }
          },
          'TipoCodigo': {
            validators: {
              notEmpty: {
                message: 'El tipo de c&oacute;digo es requerido'
              }
            }
          },
    ...
    tipoCodigoRadios.forEach(function (radio) {
      radio.addEventListener('change', function () {
        if (radio.value === '2') {
          validator.enableValidator('Correos');
  ...
  const initCodePreview = () => {

    const codigo = document.getElementById('Codigo');
    const codigoPreview = document.getElementById('codigo-descuento');
    codigoPreview.innerHTML = codigo.value;
  };
  ...
  return {
    // Initialization
    init: function () {
      form = document.querySelector('#kt_descuentos_in_form');
      submitButton = document.querySelector('#kt_descuentos_in_submit');
