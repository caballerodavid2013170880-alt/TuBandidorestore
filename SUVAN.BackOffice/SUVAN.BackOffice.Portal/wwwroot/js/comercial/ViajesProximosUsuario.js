var KTViajesList = function () {
    ...
    var table = document.getElementById('kt_table_ViajesProximosUsuarios');
    var datatable;
    ...
    return {
        ...
        init: function () {
            ...
            datatable.on('draw.dt', function () {
                $('#kt_table_ViajesProximosUsuarios tbody tr').each(function () {
    ...
    if ($(this).val() != "") {
        ...
        switch (parseInt($(this).val())) {
            ...
            case 6:
                ...
                var table = $("#kt_table_ViajesProximosUsuarios").DataTable();
...
function filtrarResultadosFecha(fechaInicio, fechaFin) {
    var miTabla = $("#kt_table_ViajesProximosUsuarios").DataTable();
    miTabla.clear().draw();
    var data = datos;
