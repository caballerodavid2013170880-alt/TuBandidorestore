var KTViajesList = function () {
    ...
    var table = document.getElementById('kt_table_Viajes');
    var datatable;
    ...
    return {
        ...
        init: function () {
            ...
            datatable.on('draw.dt', function () {
                $('#kt_table_Viajes tbody tr').each(function () {
    ...
    if ($(this).val() != "") {
        ...
        switch (parseInt($(this).val())) {
            ...
            case 6:
                ...
                var table = $("#kt_table_Viajes").DataTable();
...
function filtrarResultadosFecha(fechaInicio, fechaFin) {
    var miTabla = $("#kt_table_Viajes").DataTable();
    miTabla.clear().draw();
