var KTViajesList = function () {
    ...
    var table = document.getElementById('kt_table_ViajesCancelados');
    var datatable;
    ...
    return {
        ...
        init: function () {
            ...
            datatable.on('draw.dt', function () {
                $('#kt_table_ViajesCancelados tbody tr').each(function () {
    ...
    if ($(this).val() != "") {
        ...
        switch (parseInt($(this).val())) {
            ...
            case 6:
                ...
                var table = $("#kt_table_ViajesCancelados").DataTable();
...
function filtrarResultadosFecha(fechaInicio, fechaFin) {
    var miTabla = $("#kt_table_ViajesCancelados").DataTable();
    miTabla.clear().draw();
