...
namespace SUVAN.BackOffice.Portal
{
    public static class ServiceConfiguration
    {
        ...
        public static void AddCatalogServices(this IServiceCollection services)
        {
            ...
            // 1407 evitar conflictos con depositos disponibles services.AddTransient<IDepositosDisponibles, DepositosDisponiblesService>();
            ...
            services.AddTransient<IVehiculoDetalleService, VehiculoDetalleService>();
            services.AddTransient<IMantenimientoService, MantenimientoService>();
            services.AddTransient<IGrupoReparacionService, GrupoReparacionService>();
            services.AddTransient<ICausaMantenimientoService, CausaMantenimientoService>();
            services.AddTransient<IBajaVehiculoService, BajaVehiculoService>();
            ...
            //Depositos
            services.AddTransient<IDepositoService, DepositosService>();
            //Departamentos
            ...
            //Cargas Por Periodo
            services.AddTransient<ICargaPeriodoService, CargaPeriodoService>();
            ...
            services.AddTransient<ILlantaInspeccionService, LlantaInspeccionService>();
